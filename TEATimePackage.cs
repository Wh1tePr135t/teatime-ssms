...
namespace TEATime
{
    ...
    /// 
    /// Key points:
    /// - Guid must be unique and match the registry entries
    /// - Implements IVsPackage for SSMS integration
    /// - AutoLoadPackage ensures the extension loads with SSMS
    /// </summary>
    [ComVisible(true)]
    ...
    public class TEATimePackage : IVsPackage
    {
        ...
        /// <summary>
        /// Called when a tool window is created
        /// </summary>
